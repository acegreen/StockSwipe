...
@property (nonatomic, strong) UIColor * __null_unspecified descriptionTextColor;
...
@property (nonatomic, strong) NSNumberFormatter * __null_unspecified valueFormatter;
...
- (void)renderGridLinesWithContext:(CGContextRef __nullable)context;
- (void)renderLimitLinesWithContext:(CGContextRef __nullable)context;
- (void)renderLimitLineLineWithContext:(CGContextRef __nullable)context limitLine:(ChartLimitLine * __nonnull)limitLine position:(CGPoint)position;
- (void)renderLimitLineLabelWithContext:(CGContextRef __nullable)context limitLine:(ChartLimitLine * __nonnull)limitLine position:(CGPoint)position yOffset:(CGFloat)yOffset;
@end
...
@property (nonatomic, readonly, strong) LineChartData * __null_unspecified lineData;
@property (nonatomic, readonly, strong) BarChartData * __null_unspecified barData;
@property (nonatomic, readonly, strong) ScatterChartData * __null_unspecified scatterData;
@property (nonatomic, readonly, strong) CandleChartData * __null_unspecified candleData;
@property (nonatomic, readonly, strong) BubbleChartData * __null_unspecified bubbleData;
...
@property (nonatomic, strong) id <ChartFillFormatter> __null_unspecified fillFormatter;
- (LineChartData * __null_unspecified)lineChartRendererData:(LineChartRenderer * __nonnull)renderer;
- (ChartTransformer * __null_unspecified)lineChartRenderer:(LineChartRenderer * __nonnull)renderer transformerForAxis:(enum AxisDependency)which;
- (id <ChartFillFormatter> __nonnull)lineChartRendererFillFormatter:(LineChartRenderer * __nonnull)renderer;
- (NSNumberFormatter * __null_unspecified)lineChartDefaultRendererValueFormatter:(LineChartRenderer * __nonnull)renderer;
...
@property (nonatomic, strong) UIColor * __nonnull centerTextColor;
@property (nonatomic, strong) UIFont * __nonnull centerTextFont;
